...
public:
    ...
    friend ostream& operator<<(ostream& out, const Card& c);    // Overload cout
};
...
public:
    ...
    ~Deck();                                // Destructor
    void addCard(const Card& c);            // Add one card
    void print() const;
    void sortCardsDesc();                   // Sort cards in descending way
    friend ostream& operator<<(ostream& out, const Deck& deck);     // Overload cout
};
